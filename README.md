...
- ⚡ 深度学习：CNN：AlexNet、VGG、ResNet、ResNeXt、SENet、GoogLeNet、DeepLab、UNet、YOLO、DETR、DINO、SSD、BiFPN、注意力等。图像分类、语义分割、目标检测、目标跟踪、三维重建等。PyTorch，TensorFlow，YOLO，OpenMMLab等
---
